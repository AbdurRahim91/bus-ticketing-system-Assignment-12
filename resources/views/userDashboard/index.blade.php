                                ...
                                <tbody>
                                    ...
                                    <tr class="duration-300 text-center">
                                        ...
                                        <td class="py-2 px-4 border-b">
                                            <a href="{{url('print_pdf',$ticketSale->id)}}" class="bg-rose-500 p-1.5 rounded-md border-2 text-white hover:border-sky-600 hover:border-2 hover:bg-white hover:text-rose-600 duration-500">Download</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
